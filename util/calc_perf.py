...
def calculate_metrics(tx_path, rx_path):
    print("======================================================================")
    print("  KALKULATOR PERFORMA MODEM DTMF (WER, SER, BER)")
    print("======================================================================")
    ...
    print(f"{'No.':<4} | {'TX Key':<10} | {'RX Key':<10} | {'Key Match':<10} | {'Sym Errors':<10} | {'Bit Errors':<10}")
    print("-" * 70)
    ...
    for i in range(num_pairs):
        ...
        print(f"{i+1:<4} | {tx_key:<10} | {rx_key:<10} | {match_str:<10} | {word_sym_err:<10} | {word_bit_err:<10}")
