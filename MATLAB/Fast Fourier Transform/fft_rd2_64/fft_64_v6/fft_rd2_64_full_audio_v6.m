...
WRITETO_WAV_DEC = 'v6_printout_wav_decimal.txt';
WRITETO_WAV_BIN = 'v6_printout_wav_binary.txt';

WRITETO_FFT_DEC_R = 'v6_printout_fft_decimal_r.txt';
WRITETO_FFT_DEC_I = 'v6_printout_fft_decimal_i.txt';
WRITETO_FFT_BIN_R = 'v6_printout_fft_binary_r.txt';
WRITETO_FFT_BIN_I = 'v6_printout_fft_binary_i.txt';

WRITETO_TWIDDLE_DEC_R = 'v6_printout_twiddle_decimal_r.txt';
WRITETO_TWIDDLE_DEC_I = 'v6_printout_twiddle_decimal_i.txt';
WRITETO_TWIDDLE_BIN_R = 'v6_printout_twiddle_binary_r.txt';
WRITETO_TWIDDLE_BIN_I = 'v6_printout_twiddle_binary_i.txt';

WRITETO_X1_DEC_R = 'v6_printout_x1_decimal_r.txt';
WRITETO_X1_DEC_I = 'v6_printout_x1_decimal_i.txt';
WRITETO_X1_BIN_R = 'v6_printout_x1_binary_r.txt';
WRITETO_X1_BIN_I = 'v6_printout_x1_binary_i.txt';

WRITETO_X2_DEC_R = 'v6_printout_x2_decimal_r.txt';
WRITETO_X2_DEC_I = 'v6_printout_x2_decimal_i.txt';
WRITETO_X2_BIN_R = 'v6_printout_x2_binary_r.txt';
WRITETO_X2_BIN_I = 'v6_printout_x2_binary_i.txt';

WRITETO_X3_DEC_R = 'v6_printout_x3_decimal_r.txt';
WRITETO_X3_DEC_I = 'v6_printout_x3_decimal_i.txt';
WRITETO_X3_BIN_R = 'v6_printout_x3_binary_r.txt';
WRITETO_X3_BIN_I = 'v6_printout_x3_binary_i.txt';

WRITETO_X4_DEC_R = 'v6_printout_x4_decimal_r.txt';
WRITETO_X4_DEC_I = 'v6_printout_x4_decimal_i.txt';
WRITETO_X4_BIN_R = 'v6_printout_x4_binary_r.txt';
WRITETO_X4_BIN_I = 'v6_printout_x4_binary_i.txt';

WRITETO_X5_DEC_R = 'v6_printout_x5_decimal_r.txt';
WRITETO_X5_DEC_I = 'v6_printout_x5_decimal_i.txt';
WRITETO_X5_BIN_R = 'v6_printout_x5_binary_r.txt';
WRITETO_X5_BIN_I = 'v6_printout_x5_binary_i.txt';

WRITETO_X6_DEC_R = 'v6_printout_x6_decimal_r.txt';
WRITETO_X6_DEC_I = 'v6_printout_x6_decimal_i.txt';
WRITETO_X6_BIN_R = 'v6_printout_x6_binary_r.txt';
WRITETO_X6_BIN_I = 'v6_printout_x6_binary_i.txt';
...
function [y_re, y_im, twiddle_r, twiddle_i, x1_re, x1_im, x2_re, ...
    ...
    lut_im = fi(sin(-2*(0:32)*(1/64*pi)), 1, 16, 10);
    ...
    for m = 0:1:(N/2 - 1)
        ...
        twiddle_re = lut_re(m+1);
        twiddle_im = lut_im(m+1);
    ...
    for m = 0:1:(N/4 - 1)
        ...
        twiddle_re = lut_re((m+1)*2);
        twiddle_im = lut_im((m+1)*2);
    ...
    for m = 0:1:(N/8 - 1)
        ...
        twiddle_re = lut_re((m+1)*4);
        twiddle_im = lut_im((m+1)*4);
    ...
    for m = 0:1:(N/16 - 1)
        ...
        twiddle_re = lut_re((m+1)*8);
        twiddle_im = lut_im((m+1)*8);
    ...
    for m = 0:1:(N/32 - 1)
        ...
        twiddle_re = lut_re((m+1)*16);
        twiddle_im = lut_im((m+1)*16);
    ...
    twiddle_re = lut_re(32);
    twiddle_im = lut_im(32);
