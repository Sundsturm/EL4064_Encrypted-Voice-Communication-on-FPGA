...
% INPUT
inputX1 = [(4*rand(1, 320))-2, tones(3,:), 4*(rand(1, 320))-2];
inputName1 = '697 Hz + 852 Hz v1';

inputX2 = [tones(3,:), 4*(rand(1, 640))-2];
inputName2 = '697 Hz + 852 Hz v2';

inputX3 = [(4*rand(1, 640))-2, tones(3,:)];
inputName3 = '697 Hz + 852 Hz v3';

fprintf('input: %s (%d samples); filter checks for 697 Hz\n',inputName,length(inputX1));
Y1_v1 = goertzel3(inputX1, 697, Fs);
fprintf('input: %s (%d samples); filter checks for 697 Hz\n',inputName,length(inputX2));
Y1_v2 = goertzel3(inputX2, 697, Fs);
fprintf('input: %s (%d samples); filter checks for 697 Hz\n',inputName,length(inputX3));
Y1_v3 = goertzel3(inputX3, 697, Fs);

fprintf('input: %s (%d samples); filter checks for 852 Hz\n',inputName,length(inputX1));
Y2_v1 = goertzel3(inputX1, 852, Fs);
fprintf('input: %s (%d samples); filter checks for 852 Hz\n',inputName,length(inputX2));
Y2_v2 = goertzel3(inputX2, 852, Fs);
fprintf('input: %s (%d samples); filter checks for 852 Hz\n',inputName,length(inputX3));
Y2_v3 = goertzel3(inputX3, 852, Fs);

fprintf('input: %s (%d samples); filter checks for 1336 Hz\n',inputName,length(inputX1));
Y3_v1 = goertzel3(inputX1, 1336, Fs);
fprintf('input: %s (%d samples); filter checks for 1336 Hz\n',inputName,length(inputX2));
Y3_v2 = goertzel3(inputX2, 1336, Fs);
fprintf('input: %s (%d samples); filter checks for 1336 Hz\n',inputName,length(inputX3));
Y3_v3 = goertzel3(inputX3, 1336, Fs);
...
p2_1 = nexttile
plot(Y1_v1)
title('697 Hz for input v1')
p2_2 = nexttile
plot(Y1_v2)
title('697 Hz for input v2')
p2_3 = nexttile
plot(Y1_v3)
title('697 Hz for input v3')

p3_1 = nexttile
plot(Y2_v1)
title('852 Hz for input v1')
p3_2 = nexttile
plot(Y2_v2)
title('852 Hz for input v2')
p3_3 = nexttile
plot(Y2_v3)
title('852 Hz for input v3')

p4_1 = nexttile
plot(Y3_v1)
title('1336 Hz for input v1')
p4_2 = nexttile
plot(Y3_v2)
title('1336 Hz for input v2')
p4_3 = nexttile
plot(Y3_v3)
title('1336 Hz for input v3')
