...
% CONFIGURE INPUT
inputX1 = [(4*rand(1, 320))-2, tones(4,:), 4*(rand(1, 320))-2];
inputName1 = '697 Hz + 770 Hz v1';

inputX2 = [tones(4,:), 4*(rand(1, 640))-2];
inputName2 = '697 Hz + 770 Hz v2';

inputX3 = [(4*rand(1, 640))-2, tones(4,:)];
inputName3 = '697 Hz + 770 Hz v3';
