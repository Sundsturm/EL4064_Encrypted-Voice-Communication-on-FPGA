...
% final version of goertzel4
% (see goertzel4_g for longer inputs)
% structure:
%   - configure parameters, configure input, filter configurations
%   - apply (call function) Goertzel algorithm
%   - plot 1, 2, 3, 4
%   - Goertzel algorithm function definition

clear all; close all;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

fileID = fopen('goertzel4_f_formatted.html','w');
...
exportgraphics(plot1, 'plot1.png','Resolution',300);
fprintf(fileID, '<img src="plot1.png" width="400px"/><br/>');
...
for i = 2:length(dtmf_freqs)+1
    ...
    exportgraphics(p3(i), ['plot3_', num2str(i), '.png'],'Resolution',300);
    fprintf(fileID, ['<img src="plot3_', num2str(i), '.png" width="900px"/><br/>']);
end
...
for i = 2:length(dtmf_freqs)+1
    ...
    exportgraphics(p4(i), ['plot4_', num2str(i), '.png'],'Resolution',300);
    fprintf(fileID, ['<img src="plot4_', num2str(i), '.png" width="900px"/><br/>']);
end
