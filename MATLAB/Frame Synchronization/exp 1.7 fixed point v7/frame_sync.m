function goertzel_enable = frame_sync(inputsignal, show_plot)
...
% =========================================
% Detection Threshold and Lookback parameters
% (Matching VHDL flaggingv2 and markingv1 generics)
% =========================================
lookback_depth       = 16;  % LOOKBACK_DEPTH in flaggingv2
threshold_coeff      = 5;   % THRESHOLD_COEFF in flaggingv2
threshold_rise_coeff = 2;   % THRESHOLD_RISE_COEFF in markingv1
threshold_fall_coeff = 2;   % THRESHOLD_FALL_COEFF in markingv1
...
if dtmf3_idx > 0
    ...
    fprintf('              Condition (Option A): curr_697 >= threshold_coeff * (curr_697 + curr_941)\n');
else
