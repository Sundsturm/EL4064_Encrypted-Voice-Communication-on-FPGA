...
entity top_dtmfencode is
    Port (
        ...
        corr_1633       : in  STD_LOGIC_VECTOR(16 downto 0); -- For A, B, C, D symbols

        out_ready       : in  STD_LOGIC;
        out_valid       : out STD_LOGIC;
        sevseg          : out STD_LOGIC_VECTOR(6 downto 0);
        anode           : out STD_LOGIC;
        encode_out      : out STD_LOGIC_VECTOR(31 downto 0)  -- 32-bit: 8 x 4-bit DTMF codes
    );
end top_dtmfencode;
...
architecture Behavioral of top_dtmfencode is
    ...
    component shift_add is
        ...
        output32                : out STD_LOGIC_VECTOR(31 downto 0)  -- 32-bit output (8 x 4-bit)
        );
    end component;
