...
-- ieee.fixed_pkg is part of VHDL-2008 standard (compile with vcom -2008)
...
architecture rtl of Goertzel_top is
    ...
    constant COEFF_852      : real    := 1.96885313617978; -- For frequency 852 Hz
    constant COEFF_941      : real    := 1.96530655866142; -- For frequency 941 Hz
    constant COEFF_1209     : real    := 1.94006250638909; -- For frequency 1209 Hz
    constant COEFF_1336     : real    := 1.93014734462309; -- For frequency 1336 Hz
    constant COEFF_1477     : real    := 1.91388067146442; -- For frequency 1477 Hz
    constant COEFF_1633     : real    := 1.89757206489700; -- For frequency 1633 Hz (A,B,C,D)
