...
entity flaggingv2 is
    generic(
        ...
        THRESHOLD_COEFF : integer := 2   -- Default: threshold pengali 2
    );
    Port (
        clk          : in  STD_LOGIC;
            ...
            case state is
                ...
                when COMPUTE =>
                    ...
                    if full = '1' then
                        ...
                        if new941 >= old_941 and new941 > to_sfixed(16.0, new941) then
                        ...
                        if new1477 >= old_1477 and new1477 > to_sfixed(16.0, new1477) then
