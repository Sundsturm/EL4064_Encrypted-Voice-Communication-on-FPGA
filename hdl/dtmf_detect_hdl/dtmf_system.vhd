...
architecture rtl of dtmf_system is
    ...
    signal power_1633 : std_logic_vector(DATA_WIDTH downto 0);
    signal encoder_out_32 : std_logic_vector(31 downto 0);
...
begin
    ...
    encoder_inst : entity work.top_dtmfencode
        port map(
            ...
            sevseg => sevseg,
            anode => anode,
            encode_out => encoder_out_32,
            dtmf_code_4bit => open,
            dtmf_code_valid => open
        );

    encode_out <= encoder_out_32(23 downto 0); -- Kebutuhan Modul Pengacak
